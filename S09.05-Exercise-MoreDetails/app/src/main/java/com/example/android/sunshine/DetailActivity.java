...
//  COMPLETFD (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
...
//      COMPLETED (13) Find each of the TextViews by ID
        mDateView = (TextView) findViewById(R.id.tv_display_date);
        mDescriptionView = (TextView) findViewById(R.id.tv_display_description);
        mHighTemperatureView = (TextView) findViewById(R.id.tv_display_high);
        mLowTemperatureView = (TextView) findViewById(R.id.tv_display_low);
        mHumidityView = (TextView) findViewById(R.id.tv_display_humidity);
        mWindView = (TextView) findViewById(R.id.tv_display_wind);
        mPressureView = (TextView) findViewById(R.id.tv_display_pressure);
...
//      COMPLETED (28) Display the high temperature
            double highInCelsius = data.getDouble(DetailActivity.INDEX_WEATHER_MAX_TEMP);
            mHighTemperatureView.setText(SunshineWeatherUtils.formatTemperature(this, highInCelsius));
//      COMPLETED (29) Display the low temperature
            double lowInCelsius = data.getDouble(DetailActivity.INDEX_WEATHER_MIN_TEMP);
            mLowTemperatureView.setText(SunshineWeatherUtils.formatTemperature(this, lowInCelsius));
//      COMPLETED (30) Display the humidity
            ...
            mHumidityView.setText(String.format(getString(humidityFormatResourceId), humidity));
//      COMPLETED (31) Display the wind speed and direction
            double windInMph = data.getDouble(DetailActivity.INDEX_WEATHER_WIND_SPEED);
            double degrees = data.getDouble(DetailActivity.INDEX_WEATHER_DEGREES);
            mWindView.setText(SunshineWeatherUtils.getFormattedWind(this, (float) windInMph, (float) degrees));
//      COMPLETED (32) Display the pressure
            ...
            mPressureView.setText(String.format(getString(pressureFormatResourceId), pressure));
